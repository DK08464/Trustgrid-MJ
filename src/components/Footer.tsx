      ...
      <div className="container mx-auto px-4 py-12">
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
          ...
          <div>
            ...
            <ul className="space-y-2">
              <li>
                <a href="#" className="text-gray-600 hover:text-charity-purple transition-colors">Home</a>
              </li>
              <li>
                <a href="#causes" className="text-gray-600 hover:text-charity-purple transition-colors">Causes</a>
              </li>
              <li>
                <a href="#how-it-works" className="text-gray-600 hover:text-charity-purple transition-colors">How It Works</a>
              </li>
              <li>
                <a href="#about" className="text-gray-600 hover:text-charity-purple transition-colors">About Us</a>
              </li>
            </ul>
          </div>
          ...
          <div>
            ...
            <ul className="space-y-2">
              <li>
                <a href="#" className="text-gray-600 hover:text-charity-purple transition-colors">FAQ</a>
              </li>
              <li>
                <a href="#" className="text-gray-600 hover:text-charity-purple transition-colors">Documentation</a>
              </li>
              <li>
                <a href="#" className="text-gray-600 hover:text-charity-purple transition-colors">Privacy Policy</a>
              </li>
              <li>
                <a href="#" className="text-gray-600 hover:text-charity-purple transition-colors">Terms of Service</a>
              </li>
            </ul>
          </div>
        </div>
        ...
        <div className="border-t border-gray-100 mt-10 pt-6 flex flex-col md:flex-row justify-between items-center">
          <p className="text-gray-500 text-sm mb-4 md:mb-0">
            &copy; {new Date().getFullYear()} EthereumHope. All rights reserved.
          </p>
          <div className="flex items-center space-x-2">
            ...
            <span className="text-xs text-gray-500">for a better world</span>
          </div>
        </div>
      </div>
    </footer>
