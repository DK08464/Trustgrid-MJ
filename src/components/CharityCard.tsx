    ...
    <Card className="overflow-hidden hover:card-shadow transition-all duration-300 h-full dark:border-gray-700 dark:bg-gray-800 flex flex-col">
        ...
        <AspectRatio ratio={16/9} className="bg-muted">
          <img 
            ...
            onError={(e) => {
              ...
              e.currentTarget.src = "https://images.unsplash.com/photo-1532629345422-7515f3d16bb6?ixlib=rb-4.0.3&auto=format&fit=crop&w=1170&q=80";
            }}
          />
        </AspectRatio>
      </div>
      <CardHeader className="pb-2">
        <div className="flex justify-between items-center">
          <Badge variant="outline" className="bg-charity-light-purple text-charity-purple hover:bg-charity-light-purple dark:bg-gray-700 dark:text-charity-purple">
            {category}
          </Badge>
